...
namespace Orangecat\Faq\Block\Adminhtml\Question\Edit;
...
class Form extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            QuestionInterface::KEY_QUESTION,
            'text',
            [
                'name'     => QuestionInterface::KEY_QUESTION,
                'label'    => __('Question'),
                'title'    => __('Question'),
                'required' => true,
        ...
        $fieldset->addField(
            QuestionInterface::KEY_ANSWER,
            'editor',
            [
                'name'     => QuestionInterface::KEY_ANSWER,
                'label'    => __('Answer'),
                'title'    => __('Answer'),
                'required' => true,
                'rows'     => '5',
